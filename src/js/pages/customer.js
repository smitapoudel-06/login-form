  ...
  try {
    ...
    content.innerHTML = `
      <div class="card profile-card anim-fade-in-up">
        <div class="profile-avatar" style="background: var(--gradient-cool);">${initials}</div>
        <h2 class="profile-name">${user.fullName || user.username || '—'}</h2>
        <p class="profile-email">${user.email}</p>
        <span class="badge badge-customer" style="margin: 0 auto var(--space-6);">CUSTOMER</span>
        ...
        <div class="profile-details">
          ...
          <div class="profile-row">
            ...
            <span class="profile-row-value"><span class="badge badge-customer">CUSTOMER</span></span>
          </div>
          <div class="profile-row">
